                                                ...
                                                <div className="row">
                                                    <div className="col-lg-3 col-md-3 col-sm-12 p-0">
                                                        <div style={autoCompleteStyles}>
                                                            <input style={input} id="fromInput" type="text" name="searchedFrom" className="form-control search-slt" placeholder="Leaving from" />
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-3 col-md-3 col-sm-12 p-0">
                                                        <div style={autoCompleteStyles}>
                                                            <input style={input} type="text" id="toInput" name="searchedTo" className="form-control search-slt" placeholder="Going to" />
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-3 col-md-3 col-sm-12 p-0">
                                                        <DatesOptions />
